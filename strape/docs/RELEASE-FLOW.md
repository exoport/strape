...
**Bumping, in practice**, from today's `0.2.0`:

| Change | `UPSTREAM_PIN` | `strape/VERSION` | Tag |
|---|---|---|---|
| Adopt upstream v0.86.0 | `v0.86.0` | `0.2.0` → `0.3.0` | `strape-v0.3.0` |
| A hunk that changes what a user sees | unchanged | `0.2.0` → `0.3.0` (pre-1.0 exception) | `strape-v0.3.0` |
| Fix a gate script, doc, or baseline | unchanged | `0.2.0` → `0.2.1` | `strape-v0.2.1` |
