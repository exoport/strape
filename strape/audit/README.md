...
| `model-catalog-<pin>.json` | content pin for the vendored model catalog: per-file sha256 plus `baseUrl`/`api`/cost/context for all 1219 models | `model-catalog.mjs --check` |
